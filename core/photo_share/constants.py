...
PNG_EXTENSIONS = {".png"}
HDR_EXTENSIONS = {".hdr"}
BROWSER_RENDERABLE_PHOTO_EXTENSIONS = JPG_EXTENSIONS | PNG_EXTENSIONS
PHOTO_EXTENSIONS = BROWSER_RENDERABLE_PHOTO_EXTENSIONS | {".heic", ".heif"} | HDR_EXTENSIONS
LIVE_PHOTO_STILL_EXTENSIONS = JPG_EXTENSIONS | {".heic", ".heif"}
